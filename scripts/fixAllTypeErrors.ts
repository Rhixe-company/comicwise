...
fixes.push({
  ...
  apply: () => {
    let content = readFileSync(join(ROOT, 'src/components/shadcn-studio/blocks/chart-sales-metrics.tsx'), 'utf-8');
...
fixes.push({
  ...
  apply: () => {
    let content = readFileSync(join(ROOT, 'src/components/shadcn-studio/blocks/ChartSalesMetrics.tsx'), 'utf-8');
...
fixes.push({
  ...
  apply: () => {
    let content = readFileSync(join(ROOT, 'src/components/shadcn-studio/blocks/widget-product-insights.tsx'), 'utf-8');
...
fixes.push({
  ...
  apply: () => {
    let content = readFileSync(join(ROOT, 'src/components/shadcn-studio/blocks/WidgetProductInsights.tsx'), 'utf-8');
...
const Recharts = RechartsPrimitive as any;`
    ...
    content = content.replace(
      /RechartsPrimitive\.Tooltip/g,
      'Recharts.Tooltip'
    );
    
    content = content.replace(
      /RechartsPrimitive\.Legend/g,
      'Recharts.Legend'
    );
...
fixes.push({
  ...
  apply: () => {
    let content = readFileSync(join(ROOT, 'src/components/ui/shadcn-io/choicebox/index.tsx'), 'utf-8');
...
fixes.push({
  ...
  apply: () => {
    let content = readFileSync(join(ROOT, 'src/components/ui/shadcn-io/color-picker/index.tsx'), 'utf-8');
...
fixes.push({
  ...
  apply: () => {
    let content = readFileSync(join(ROOT, 'src/components/ui/shadcn-io/dropzone/index.tsx'), 'utf-8');
