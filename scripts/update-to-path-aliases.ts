...
const pathAliases: Array<{
  ...
  { alias: "db", pattern: /from ['"]@\/database\/db['"]/g, replacement: 'from "db"', priority: 10 },
  {
    alias: "schema",
  ...
  // Medium priority - directory paths
  {
    ...
    replacement: 'from "actions/$1"',
    priority: 5,
  },
  {
    alias: "admin",
    pattern: /from ['"]@\/components\/admin\/([^'"]+)['"]/g,
    replacement: 'from "admin/$1"',
    priority: 5,
  },
  {
    alias: "dal",
  ...
  },
  {
    ...
    replacement: 'from "mutations/$1"',
    priority: 5,
  },
  {
    alias: "queries",
    pattern: /from ['"]@\/database\/queries\/([^'"]+)['"]/g,
    replacement: 'from "queries/$1"',
    priority: 5,
  },
  {
    alias: "services",
  ...
  },
  {
    ...
    replacement: 'from "validations/$1"',
    priority: 5,
  },
