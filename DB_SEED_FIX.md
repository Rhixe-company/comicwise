...
✅ Loads 4 users, 627 comics, 5,814 chapters
✅ Validates all data using Zod schemas
✅ Updates database with onConflictDoUpdate
...
All data is validated, images are processed, and database operations use `onConflictDoUpdate` for idempotent seeding.
