...
The project uses **`run-optimized.ts`** which is fully functional and
production-ready.
...
Available for testing but not recommended for production use. The standard seed
system (`run-optimized.ts`) is sufficient and proven.
