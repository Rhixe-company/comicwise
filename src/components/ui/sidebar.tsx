  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`
            bg-sidebar group-data-[variant=floating]:border-sidebar-border flex size-full
            flex-col
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      className={cn(
        `
          text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-3.5 right-3
          flex aspect-square w-5 items-center
          justify-center rounded-md p-0
...
const sidebarMenuButtonVariants = cva(
  `
    peer/menu-button ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-accent
    data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground flex w-full
    items-center
    gap-2
    ...
    group-data-[collapsible=icon]:p-2! focus-visible:ring-2
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      className={cn(
        `
          text-sidebar-foreground ring-sidebar-ring peer-hover/menu-button:text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-1.5
          right-1 flex aspect-square w-5
    ...
    <div
      className={cn(
        `
          ...
          items-center justify-center rounded-md px-1 text-xs
    ...
    <Comp
      className={cn(
        `
          ...
          flex h-7 min-w-0 -translate-x-px
          items-center
